...
const TabContent = ({
  ...
  switch (activeTab) {
    ...
    case 'HomePlan':
      content = <HomePlan seed={{ ...formData.exercisePlan, recoverySupport: formData.recoverySupport }} formData={formData} onNext={handleNext} sidebarWidth={260} patientData={patientData} />
      break
